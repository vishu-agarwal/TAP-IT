...
class ViewController: UIViewController {
    ...
    private let view1: UIView = {
        ...
        view.frame = CGRect(x: 50, y: view.safeAreaInsets.top + 100, width: 80, height: 80)
        return view
    }()
    ...
    private let view3 : UIView = {
        let view = UIView()
        view.backgroundColor = .orange
        view.frame = CGRect(x: 250, y: view.safeAreaInsets.top + 100, width: 80, height: 80)
        return view
    }()
    private let view4 : UIView = {
        let view = UIView()
        view.backgroundColor = .orange
        view.frame = CGRect(x: 50, y:200, width: 80, height: 80)
        return view
    }()
    private let view5 : UIView = {
        let view = UIView()
        view.backgroundColor = .orange
        view.frame = CGRect(x: 150, y: 200, width: 80, height: 80)
        return view
    }()
    private let view6 : UIView = {
        let view = UIView()
        view.backgroundColor = .orange
        view.frame = CGRect(x: 250, y: 200, width: 80, height: 80)
        return view
    }()
    private let view7 : UIView = {
        let view = UIView()
        view.backgroundColor = .orange
        view.frame = CGRect(x: 50, y: 300, width: 80, height: 80)
        return view
    }()
    private let view8 : UIView = {
        let view = UIView()
        view.backgroundColor = .orange
        view.frame = CGRect(x: 150, y: 300, width: 80, height: 80)
        return view
    }()
    private let view9 : UIView = {
        let view = UIView()
        view.backgroundColor = .orange
        view.frame = CGRect(x: 250, y: 300, width: 80, height: 80)
        return view
    }()
    ...
    private let timelbl: UILabel = {
        ...
        label.frame = CGRect(x: 100, y: 400, width: 120, height: 50)
        return label
    }()
    ...
    private let seclbl: UILabel = {
        ...
        label.frame = CGRect(x: 220, y: 400, width: 100, height: 50)
        return label
    }()
    ...
    private let Scorelabel : UILabel = {
        ...
        label.frame = CGRect(x: 80, y: 500, width: 130, height: 50)
        return label
    }()
    ...
    private let Score : UILabel = {
        ...
        label.textColor = .blue
        label.font = .boldSystemFont(ofSize: 25)
        label.frame = CGRect(x: 175, y: 500, width: 100, height: 50)
        return label
    }()
...
extension ViewController
{
        ...
        @objc private func Timerstart(){
            ...
            if(self.time==0){
                ...
                let alert = UIAlertController(title: "Your Score Is \(score)", message: " ", preferredStyle: .alert)
                alert.addTextField { (tf) in tf.placeholder = "Enter Your Name"}
                
                let action = UIAlertAction(title: "submit", style: .default) { (_) in
                    self.name = (alert.textFields?.first?.text)!
                    if  self.name == (alert.textFields?.first?.text)!{
